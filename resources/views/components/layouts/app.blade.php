...
<body class="min-h-screen bg-[var(--tu-bg)]" x-data="{ sidebarOpen: false }">
    ...
    <aside class="tu-sidebar fixed top-0 left-0 h-full w-64 z-50 flex flex-col transition-transform duration-300"
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            {{-- Minha Assinatura — apenas colaboradores (gestores têm seção própria abaixo) --}}
            @if($authUser?->isEmployee())
            <div class="pt-4 pb-2">
                <span class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Minha Conta</span>
            </div>
            <a href="{{ route('my-subscription') }}"
               class="tu-sidebar-link {{ request()->routeIs('my-subscription') ? 'active' : '' }}" wire:navigate>
            ...
            <a href="{{ route('admin.library') }}"
               class="tu-sidebar-link {{ request()->routeIs('admin.library') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"/></svg>
                <span>Biblioteca</span>
            </a>
            <a href="{{ route('admin.badges') }}"
               class="tu-sidebar-link {{ request()->routeIs('admin.badges') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg>
                <span>Conquistas</span>
            </a>
            <a href="{{ route('admin.challenges') }}"
               class="tu-sidebar-link {{ request()->routeIs('admin.challenges') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/></svg>
                <span>Desafios</span>
            </a>
            <a href="{{ route('admin.certificates') }}"
               class="tu-sidebar-link {{ request()->routeIs('admin.certificates') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
                <span>Certificados</span>
            </a>
            <a href="{{ route('admin.forum') }}"
               class="tu-sidebar-link {{ request()->routeIs('admin.forum') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"/></svg>
                <span>Fórum</span>
            </a>
            ...
            <a href="{{ route('platform.users') }}"
               class="tu-sidebar-link {{ request()->routeIs('platform.users') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                <span>Usuários</span>
            </a>
            <a href="{{ route('platform.levels') }}"
               class="tu-sidebar-link {{ request()->routeIs('platform.levels') ? 'active' : '' }}" wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                <span>XP e Níveis</span>
            </a>
            ...
            <a href="{{ route('platform.diagnostics.prompts') }}"
               class="tu-sidebar-link {{ request()->routeIs('platform.diagnostics.prompts') ? 'active' : '' }}"
               wire:navigate>
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
